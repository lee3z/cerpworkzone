		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori First Application",
									"targetURL": "#comsapzfioritraining1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapzfioritraining1-display": {
								"semanticObject": "comsapzfioritraining1",
								"action": "display",
								"description": "Fiori Application using Northwind OData Service",
								"title": "Fiori First Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.zfioritraining1",
									"url": sap.ui.require.toUrl("com/sap/zfioritraining1")
								}
							}
						}
					}
